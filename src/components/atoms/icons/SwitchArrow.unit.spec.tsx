...
describe('SwitchArrow component', () => {
  it('renders correctly with default props', () => {
    const { getByTestId } = render(<SwitchArrow />);

    const svg = getByTestId('SwitchArrow');
