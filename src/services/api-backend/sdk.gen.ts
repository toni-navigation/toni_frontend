...
export const favoritesControllerFindHomeAddress = <ThrowOnError extends boolean = false>(options?: Options<FavoritesControllerFindHomeAddressData, ThrowOnError>) => {
    return (options?.client ?? client).get<FavoritesControllerFindHomeAddressResponse, unknown, ThrowOnError>({
        ...options,
