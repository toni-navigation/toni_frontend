...
export const favoritesControllerFindHomeAddressQueryKey = (options?: Options<FavoritesControllerFindHomeAddressData>) => [
    createQueryKey('favoritesControllerFindHomeAddress', options)
];

export const favoritesControllerFindHomeAddressOptions = (options?: Options<FavoritesControllerFindHomeAddressData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await favoritesControllerFindHomeAddress({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: favoritesControllerFindHomeAddressQueryKey(options)
    });
};
